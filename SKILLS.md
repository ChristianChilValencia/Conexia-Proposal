...
## conexia-role-flow
- Maintain all seven roles: Department Staff, IRO Staff, IRO Admin, Legal Counsel, President's Office, Super Admin, Department Admin.
- Keep role copy, pages, permissions, and dashboards consistent with user requirements.
- Department roles see department-scoped data; executive/admin roles see wider oversight views.
- Super Admin is governance-only and must not perform workflow decisions.
